...
rows=[]
fields=[]
with open('Desktop/PROJECTS/RATION-DISTRIBUTION-ANALYSIS-AND-PREDICTION-SYSTEM/Machine Learning in Python/REGRESSION_SECOND/compressed_data_clustering.csv','r') as csv_input:
